...
public class FollowPlayer : MonoBehaviour
{
    ...
    [SerializeField] bool predictPlayerPosition;
    private Camera cam;
    ...
    private void Update()
    {
        ...
        Vector2 targetPosition = (Vector2)GameManager.playerRB.transform.position + Vector2.up * cameraHeight + (predictPlayerPosition ? GameManager.playerRB.linearVelocity : Vector2.zero);
